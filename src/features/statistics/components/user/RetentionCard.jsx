...
export default function RetentionCard({ data }) {
  ...
  const rate = selectedDays === 7 ? data.day7 : data.day30;
  ...
  return (
    <div className="w-full max-w-[552px] rounded-[10px] border border-neutral-200 bg-white p-6">
      ...
      <p className="mb-2 text-3xl font-semibold text-neutral-950">{rate}%</p>

      <p className="text-xs text-neutral-600">가입 후 {selectedDays}일 내 재방문 비율</p>
    </div>
  );
}
